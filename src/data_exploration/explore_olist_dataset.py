...
class OlistDataExplorer:
    ...
    def explore_customers(self):
        ...
        print(
            f"  - Diferencia: {df['customer_id'].nunique() - df['customer_unique_id'].nunique():,} "
    ...
    def explore_payments(self):
        ...
        print("\nMonto promedio por tipo de pago:")
        print(
            df.groupby("payment_type")["payment_value"].agg(["mean", "median", "count"])
        )
    ...
    def explore_reviews(self):
        ...
        print("\nEjemplos de reviews con 1 estrella:")
        bad_reviews = (
            df[df["review_score"] == 1]["review_comment_message"].dropna().head(3)
        )
        ...
        print("\nEjemplos de reviews con 5 estrellas:")
        good_reviews = (
            df[df["review_score"] == 5]["review_comment_message"].dropna().head(3)
        )
    ...
    def check_data_quality(self):
        ...
        if len(orphan_customers) == 0:
            ...
            print(
                f"{len(orphan_customers)} customers en orders NO existen en customers"
            )
        ...
        if len(orphan_products) == 0:
            ...
            print(
                f"{len(orphan_products)} products en order_items NO existen en products"
            )

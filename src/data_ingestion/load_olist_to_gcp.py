...
class OlistGCPLoader:
    ...
    def __init__(self, project_id: str, data_dir: str = "../../data/raw"):
    ...
    def load_csv_to_bigquery(self, gcs_uri: str, table_id: str, schema: list = None):
        ...
        try:
            ...
            if table_id in self.TABLES_WITH_SPECIAL_CSV:
                ...
                job_config.allow_quoted_newlines = special.get(
                ...
                print(
                    f"  ⚙️  {table_id}: usando config CSV especial "
        ...
        schemas = {
            ...
            "olist_orders_dataset": [
                ...
                bigquery.SchemaField(
                    "order_purchase_timestamp", "TIMESTAMP", mode="REQUIRED"
                ),
            ...
            "olist_geolocation_dataset": [
                bigquery.SchemaField(
                    "geolocation_zip_code_prefix", "STRING", mode="REQUIRED"
                ),
            ...
            "product_category_name_translation": [
                bigquery.SchemaField(
                    "product_category_name", "STRING", mode="REQUIRED"
                ),
    ...
    def run_sample_queries(self):
        ...
        for row in result:
            print(
                f"  {row['customer_city']}, {row['customer_state']}: {row['num_customers']:,}"
            )
        ...
        for row in result:
            ...
            print(
                f"  {row['year_month']}: {row['num_orders']:,} órdenes - "
        ...
        for row in result:
            category_en = (
                row["product_category_name_english"] or row["product_category_name"]
            )
